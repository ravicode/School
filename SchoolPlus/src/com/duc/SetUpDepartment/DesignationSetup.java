...
/*
 * DesignationSetup.java
 *
 * Created on Dec 19, 2009, 1:03:12 AM
 */
 ...
 * @author Ravi
 */
public class DesignationSetup extends javax.swing.JInternalFrame {
DefaultTableModel dm;
    /** Creates new form DesignationSetup */
...
try
{
    ...
    ps=con.prepareStatement("insert into staffdesignationsetup (designationtitle) values(?)");
...
catch(Exception e)
{
    ...
    public void removeMedium()
    {
       // con= new com.duc.DatabaseConnection.DatabaseConnection().dataConnection();
        ...
        try
        {
         ps=con.prepareStatement("delete from staffdesignationsetup where designationtitle=?");
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Staff Designation Creator");
        ...
        jTextPane3.setText("                Staff Designation");
        jScrollPane4.setViewportView(jTextPane3);

        jTextPane4.setBackground(new java.awt.Color(204, 204, 255));
        jTextPane4.setEditable(false);
        jTextPane4.setText("Add your school staff designations..");
        jScrollPane5.setViewportView(jTextPane4);

        jLabel1.setText("DesignationTitle");
