...
/*
 * LedgerPeriodicFeeSetup.java
 *
 * Created on Nov 15, 2009, 5:19:29 PM
 */
 ...
 * @author Ravi
 */
public class LedgerPeriodicFeeSetup extends javax.swing.JInternalFrame {
...
HashMap periodicfeemap1=mp.getPeriodicFeeIndexFromName();
    /** Creates new form LedgerPeriodicFeeSetup */
    public LedgerPeriodicFeeSetup() {
        initComponents();
         pack();
...
// con= new com.duc.DatabaseConnection.DatabaseConnection().dataConnection();
 ...
 // con.close();
    ...
    public void fromPeriodicFeeHead()
{
   // con= new com.duc.DatabaseConnection.DatabaseConnection().dataConnection();
    try
    {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Ledger Periodic Fee Setup");
        ...
        jTextPane3.setText("                 Ledger Periodic Fee Setup");
        jScrollPane4.setViewportView(jTextPane3);

        jTextPane4.setBackground(new java.awt.Color(204, 204, 255));
        jTextPane4.setEditable(false);
        jTextPane4.setText("Add Ledger code for your periodic fee heads..");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(select==JOptionPane.OK_OPTION)
            updateLedgerPeriodicDuesFeeHead();// TODO add your handling code here:
...
public void oldLedgerFeeHead()
{
       ...
       try
       {
           ps = con.prepareStatement("select * from periodicfeeamounthead");
          ...
          while(rs.next())
            ...
            while(rs.next())
            {
                ...
                dm.setValueAt(periodicfeemap.get(rs.getInt(1)), i, 1);
...
public void updateLedgerPeriodicFeeHead()
    {
       
        try
        {
         ps=con.prepareStatement("update periodicfeeamounthead set ledgercode=? where class=? and head=?");
         ...
         ps.setInt(3,Integer.parseInt(periodicfeemap1.get(feehead.getSelectedItem()).toString()));
         ps.executeUpdate();
         //dm.removeRow(row);
        //  con.close();
...
public void updateLedgerPeriodicDuesFeeHead()
    {
        
        try
        {
         ps=con.prepareStatement("update feedues,studententry set ledgercode=? where studentid=id and class=? and head=? and feetype=2");
