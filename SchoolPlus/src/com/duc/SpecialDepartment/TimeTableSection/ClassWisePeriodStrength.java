 ...
 * @author sourabh
 */
public class ClassWisePeriodStrength extends javax.swing.JInternalFrame {
   ...
   // MapForIndex mp =new MapForIndex();
    ...
    public ClassWisePeriodStrength() {
        initComponents();
     ...
     public void loadList()
    {
        try
        {
         ps=con.prepareStatement("select class,section,count(*) from `periodallotment` group by class,section");
         rs=ps.executeQuery();
         int i=0;
         while(rs.next())
         {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Class wise period strength");

        jTextPane1.setBackground(new java.awt.Color(204, 204, 204));
        jTextPane1.setEditable(false);
        jTextPane1.setFont(new java.awt.Font("Tahoma", 1, 11));
        jTextPane1.setText("                                                        Class & Section wise periods strength");
        ...
        jXTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Class", "Section", "Current Period Strength"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
        String s=" ";
        s+=" Class & section Wise Periods Strength List";
