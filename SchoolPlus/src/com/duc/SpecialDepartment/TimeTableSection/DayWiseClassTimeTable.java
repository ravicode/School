 ...
 * @author sourabh
 */
public class DayWiseClassTimeTable extends javax.swing.JInternalFrame {
    ...
    public void loadClassAndSection()
    {
        ...
        {
          String t="";
          ps=con.prepareStatement("select classtitle,sectiontitle from sectionsetup  order by classtitle asc,sectiontitle asc");
          rs=ps.executeQuery();
          int i=0;
          while(rs.next())
          i++;
          ...
          while(rs.next())
          {
          tcodes.add(rs.getString(1)+rs.getString(2));
          t="<html><font size=3>"+String.valueOf(classmap.get(rs.getInt(1)))+"-"+String.valueOf(sectionmap.get(rs.getInt(2)))+"</font></html>";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
         try
        {         
        String s="Class' Schedule For Day: "+cmbDay.getSelectedItem().toString();
    ...
    public void loadAllClassTimeTable()
    {
      int r=0,c=0;
      String period="";
      fillEmptyTimeTable();
      try
      {
          ps=con.prepareStatement("select teachercode,name,class,section,subject,periodallotment.column from periodallotment,staffentry where teachercode=code and row=? ");
          ps.setInt(1, cmbDay.getSelectedIndex()-1);
          rs=ps.executeQuery();
          while(rs.next())
          {
           r=tcodes.indexOf(rs.getString(3)+rs.getString(4));
           c=rs.getInt(6);
           if(r>=0)
           {
           period="<html><font color='blue'>["+rs.getString(1)+"] "+rs.getString(2) +"</font><br /><font color='green'>"+String.valueOf(subjectmap.get(rs.getInt(5)))+"</font></html>";
