 ...
 * BusFuel.java
 *
 * Created on Oct 6, 2009, 2:02:32 AM
 */
 ...
 */
public class BusFuel extends javax.swing.JInternalFrame {
DefaultTableModel dm;
    /** Creates new form BusFuel */
    public BusFuel() {
        initComponents();
        pack();
...
try
{
    ps=con.prepareStatement("update transportfuel  set receivedby=?,fuel=?,cost=?,remarks=?,date=? where busno=?");
...
try
{
    ps=con.prepareStatement("Select * from transportfuel where busno=?");
...
e.printStackTrace();
    ...
    public void deleteDonar()
    {
        ...
        try
        {
         ps=con.prepareStatement("delete from transportfuel where busno=?");
    ...
    else
{
 ...
 try
 {
     ps=con.prepareStatement("insert into transportfuel values(?,?,?,?,?,?,?)");
...
int ledcode=0;
   ...
   // con=new com.duc.DatabaseConnection.DatabaseConnection().dataConnection();
    ...
    private void initComponents() {
        ...
        jTextPane2.setText("                                  Transport Fuel Record         "); // NOI18N
        ...
        jLabel10.setText("List of Re-Fuelling Record"); // NOI18N
        ...
        jTextPane3.setText("Maintain the record of Bus Fuel intake...."); // NOI18N
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(receivedby, javax.swing.GroupLayout.PREFERRED_SIZE, 124, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(issuedon, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 124, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(litres, javax.swing.GroupLayout.DEFAULT_SIZE, 124, Short.MAX_VALUE)))
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                .addComponent(jLabel1, javax.swing.GroupLayout.DEFAULT_SIZE, 74, Short.MAX_VALUE)
                                .addGap(18, 18, 18)
                                .addComponent(busCombo, javax.swing.GroupLayout.PREFERRED_SIZE, 123, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(33, 33, 33))
                    .addGroup(jPanel1Layout.createSequentialGroup()
...
}catch(Exception e)
{
 e.printStackTrace();
    ...
    private void busComboActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_busComboActionPerformed
       ...
       // String s=busCombo.getSelectedItem().toString();
      //  oldSubject();
        // TODO add your handling code here:
