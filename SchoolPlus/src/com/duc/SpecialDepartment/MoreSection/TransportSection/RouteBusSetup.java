 ...
 * RouteSetup.java
 *
 * Created on Oct 6, 2009, 2:01:08 AM
 */
 ...
 */
public class RouteBusSetup extends javax.swing.JInternalFrame {
DefaultTableModel dm;
    /** Creates new form RouteSetup */
    public RouteBusSetup() {
        initComponents();
        pack();
...
try
{
    ...
    ps=con.prepareStatement("insert into transportroutebussetup values(?,?)");
...
catch(Exception e)
{
    ...
    private void oldSubject()
    {
       ...
       try
       {
           ps = con.prepareStatement("select * from transportroutebussetup where routeno=?");
           ps.setString(1,jComboBox1.getSelectedItem().toString());
    ...
    public void removeSubject()
    {
       // con= new com.duc.DatabaseConnection.DatabaseConnection().dataConnection();
        ...
        try
        {
         ps=con.prepareStatement("delete from transportroutebussetup where busno=? and routeno=?");
...
public void fromRouteSetup()
{
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Route-Bus Setup");

        jPanel1.setBackground(new java.awt.Color(0, 153, 153));

        jButton1.setText("Add Bus No.");
        ...
        jButton3.setText("Remove Bus No.");
        ...
        jTextPane3.setText("                      Add Bus Number");
        jScrollPane4.setViewportView(jTextPane3);

        jTextPane4.setBackground(new java.awt.Color(204, 204, 255));
        jTextPane4.setEditable(false);
        jTextPane4.setText("Add Bus Number for a particular route no.. ");
