...
public class AddPublisher extends javax.swing.JInternalFrame {
    ...
    public void loadNameList()
    {
         try
        {
           // con= new com.duc.DatabaseConnection.DatabaseConnection().dataConnection();
            ps=con.prepareStatement("select publishername from bookpublisher order by publishername asc");
            rs=ps.executeQuery();
            int j=0,i=0;
            while(rs.next())
            {
            ...
            labelPublisher.setText(String.valueOf(i));
           // con.close();
        }
        catch(Exception e)
        {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Add Book Publisher");

        jTextPane1.setBackground(new java.awt.Color(204, 204, 204));
        jTextPane1.setEditable(false);
        jTextPane1.setFont(new java.awt.Font("Tahoma", 1, 12));
        jTextPane1.setText("                                                      Book Publishers");
        jScrollPane1.setViewportView(jTextPane1);

        jTextPane2.setBackground(new java.awt.Color(204, 204, 204));
        jTextPane2.setEditable(false);
        jTextPane2.setFont(new java.awt.Font("Tahoma", 1, 11));
        jTextPane2.setText("Add different book publishers i.e. TMH, Pearson, BPB, Galgotia, Rupa, S. Chand etc.");
        ...
        jLabel2.setText("Total Publishers :");

        labelPublisher.setFont(new java.awt.Font("Tahoma", 1, 11));
        labelPublisher.setText("0");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(nameText, javax.swing.GroupLayout.DEFAULT_SIZE, 184, Short.MAX_VALUE))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGap(28, 28, 28)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(labelPublisher, javax.swing.GroupLayout.PREFERRED_SIZE, 56, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(b==true)
        {
        JOptionPane.showMessageDialog(null,"Publisher Already Exists!","Message",JOptionPane.WARNING_MESSAGE);
        return;
        }
        addName();
        loadNameList();
      ...
      public boolean checkIfExists()
    {
     boolean b=false;
      try
        {
           // con= new com.duc.DatabaseConnection.DatabaseConnection().dataConnection();
            ps=con.prepareStatement("select * from bookpublisher where publishername=?");
    ...
    public void addName()
    {
        ...
        {
           // con= new com.duc.DatabaseConnection.DatabaseConnection().dataConnection();
            ps=con.prepareStatement("insert into bookpublisher(publishername) values (?)");
            ps.setString(1, nameText.getText());
            ps.executeUpdate();
           //  con.close();
    ...
    public void removeName()
    {
        ...
        {
           // con= new com.duc.DatabaseConnection.DatabaseConnection().dataConnection();
            ps=con.prepareStatement("delete from bookpublisher where publishername=?");
            ps.setString(1, nameText.getText());
            ps.executeUpdate();
            // con.close();
