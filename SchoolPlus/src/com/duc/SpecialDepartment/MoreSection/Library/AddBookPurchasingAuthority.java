 ...
 * @author sourabh
 */
public class AddBookPurchasingAuthority extends javax.swing.JInternalFrame {

    /** Creates new form AddPublisher */
    public AddBookPurchasingAuthority() {
        initComponents();
    ...
    public void loadNameList()
    {
         try
        {
            ...
            ps=con.prepareStatement("select * from bookpurchaseauthority order by authorityname asc");
            rs=ps.executeQuery();
            int j=0,i=0;
            while(rs.next())
            {
            ...
            labelAuthority.setText(String.valueOf(i));            
            // con.close();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Add Book Purchasing Authorities");

        jTextPane1.setBackground(new java.awt.Color(204, 204, 204));
        jTextPane1.setEditable(false);
        jTextPane1.setFont(new java.awt.Font("Tahoma", 1, 12));
        jTextPane1.setText("                                               Book Purchase Authority");
        jScrollPane1.setViewportView(jTextPane1);

        jTextPane2.setBackground(new java.awt.Color(204, 204, 204));
        jTextPane2.setEditable(false);
        jTextPane2.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jTextPane2.setText("Configure purchase authorities i.e. Librarian, Principal, Director etc.");
        ...
        jLabel1.setText("Authority  Name");
        ...
        jLabel2.setText("Total Authorities :");

        labelAuthority.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        labelAuthority.setText("0");
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(labelAuthority, javax.swing.GroupLayout.DEFAULT_SIZE, 96, Short.MAX_VALUE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(28, 28, 28)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(b==true)
        {
        JOptionPane.showMessageDialog(null,"Authority Already Exists!","Message",JOptionPane.WARNING_MESSAGE);
        return;
        }
        addName();
        loadNameList();
     ...
     public boolean checkIfExists()
    {
     boolean b=false;
      try
        {
           // con= new com.duc.DatabaseConnection.DatabaseConnection().dataConnection();
            ps=con.prepareStatement("select * from bookpurchaseauthority where authorityname=?");
    ...
    public void addName()
    {
        ...
        {
           // con= new com.duc.DatabaseConnection.DatabaseConnection().dataConnection();
            ps=con.prepareStatement("insert into bookpurchaseauthority(authorityname) values (?)");
            ps.setString(1, nameText.getText());
            ps.executeUpdate();
            // con.close();
    ...
    public void removeName()
    {
        ...
        {
            //con= new com.duc.DatabaseConnection.DatabaseConnection().dataConnection();
            ps=con.prepareStatement("delete from bookpurchaseauthority where authorityname=?");
            ps.setString(1, nameText.getText());
            ps.executeUpdate();
             //con.close();
        }
    ...
    private javax.swing.JLabel labelAuthority;
