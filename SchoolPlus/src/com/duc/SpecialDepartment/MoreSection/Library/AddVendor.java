...
public class AddVendor extends javax.swing.JInternalFrame {
    ...
    public void loadNameList()
    {
         try
        {
           // con= new com.duc.DatabaseConnection.DatabaseConnection().dataConnection();
            ps=con.prepareStatement("select vendorname from bookvendor order by vendorname asc");
            rs=ps.executeQuery();
            int j=0,i=0;
            while(rs.next())
            {
            ...
            //con.close();
            labelVendors.setText(String.valueOf(i));
        }
        catch(Exception e)
        {
    ...
    private void initComponents() {
        ...
        labelVendors = new javax.swing.JLabel();

        setBackground(new java.awt.Color(0, 204, 204));
        setClosable(true);
        setIconifiable(true);
        setTitle("Add Book Vendor ");

        jTextPane1.setBackground(new java.awt.Color(204, 204, 204));
        jTextPane1.setEditable(false);
        jTextPane1.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jTextPane1.setText("                                                   Book Vendors");
        jScrollPane1.setViewportView(jTextPane1);

        jTextPane2.setBackground(new java.awt.Color(204, 204, 204));
        jTextPane2.setEditable(false);
        jTextPane2.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jTextPane2.setText("Add different book vendors from where school has purchased the  books.");
        ...
        jLabel2.setText("Total Vendors :");

        labelVendors.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        labelVendors.setText("0");
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(labelVendors, javax.swing.GroupLayout.PREFERRED_SIZE, 53, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(55, 55, 55)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(b==true)
        {
        JOptionPane.showMessageDialog(null,"Vendor Already Exists!","Message",JOptionPane.WARNING_MESSAGE);
        return;
        }
        addName();
        loadNameList();
      ...
      public boolean checkIfExists()
    {
     boolean b=false;
      try
        {
           // con= new com.duc.DatabaseConnection.DatabaseConnection().dataConnection();
            ps=con.prepareStatement("select * from bookvendor where vendorname=?");
    ...
    public void addName()
    {
        ...
        {
           // con= new com.duc.DatabaseConnection.DatabaseConnection().dataConnection();
            ps=con.prepareStatement("insert into bookvendor(vendorname) values (?)");
            ps.setString(1, nameText.getText());
            ps.executeUpdate();
           // con.close();
        }
    ...
    public void removeName()
    {
        ...
        {
           // con= new com.duc.DatabaseConnection.DatabaseConnection().dataConnection();
            ps=con.prepareStatement("delete from bookvendor where vendorname=?");
            ps.setString(1, nameText.getText());
            ps.executeUpdate();
           // con.close();
        }
    ...
    private javax.swing.JLabel labelVendors;
