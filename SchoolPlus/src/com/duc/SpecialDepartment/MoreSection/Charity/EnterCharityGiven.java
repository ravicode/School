 ...
 */
public class EnterCharityGiven extends javax.swing.JInternalFrame {
DefaultTableModel dm;
    /** Creates new form EnterCharityData */
    public EnterCharityGiven() {
        initComponents();
         pack();
...
public void updateGivenRecord()
    {
      itemname.setEditable(false);
//con= new com.duc.DatabaseConnection.DatabaseConnection().dataConnection();
try
{
    ps=con.prepareStatement("update charitygiven set usedfor=?,amount=?,other=?,remarks=?,date=? where charitygivento=? and serial=?");
 ...
 ps.setString(3,other.getText());
    ...
    ps.setInt(7,Integer.parseInt(acceptorid.getText()));
    ps.executeUpdate();
...
try
{
    ps=con.prepareStatement("Select * from charitygiven where charitygivento=? and serial=?");
 ...
 other.setText(rs.getString(4));
    remarks.setText(rs.getString(5));
    issuedon.setText(rs.getString(6));
acceptorid.setText(String.valueOf(rs.getInt(8)));
...
e.printStackTrace();
    ...
    public void deleteGiven()
    {
        ...
        try
        {
         ps=con.prepareStatement("delete from charitygiven where charitygivento=? and serial=?");
    ...
    public void addGiven()
    {
        if(itemname.getText().isEmpty())
            JOptionPane.showConfirmDialog(null,"No Acceptor Filled","Product Blanck Alarm",JOptionPane.OK_CANCEL_OPTION);
    else
{
       // con= new com.duc.DatabaseConnection.DatabaseConnection().dataConnection();
 try
 {
     ps=con.prepareStatement("insert into charitygiven (charitygivento,usedfor,amount,other,remarks,date,ledgercode) values(?,?,?,?,?,?,?)");
 ps.setString(1,itemname.getText());

  ps.setString(2,receivedby.getText());

 ps.setDouble(3,Double.parseDouble(amountgiven.getText()));
ps.setString(4,other.getText());
...
int ledcode=0;
    ...
    ps.setInt(1,ledcode);
    ps.setString(2,"Cr.");
    ps.setString(3,"Charity Given");
    ps.setString(4,"Receiver="+itemname.getText());
    ...
    private void initComponents() {
        ...
        acceptorid = new javax.swing.JTextField();
        ...
        jTextPane2.setText("                                   Charity Given Record         "); // NOI18N
        jTextPane2.setAutoscrolls(false);
        jScrollPane2.setViewportView(jTextPane2);

        jLabel1.setText("Given  to"); // NOI18N

        jLabel2.setText("Date"); // NOI18N

        jLabel4.setText("Received By"); // NOI18N

        jLabel10.setText("List of Acceptor"); // NOI18N
        ...
        jButton3.setText("Show Acceptor"); // NOI18N
        ...
        jButton4.setText("Delete Acceptor"); // NOI18N
        ...
        jTextPane3.setText("Maintain the record of charity given"); // NOI18N
        jScrollPane3.setViewportView(jTextPane3);

        issuedon.setBackground(new java.awt.Color(153, 153, 153));
        issuedon.setEditable(false);

        jLabel3.setText("Acceptor Id"); // NOI18N

        acceptorid.setBackground(new java.awt.Color(204, 204, 204));
        acceptorid.setEditable(false);
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(acceptorid, javax.swing.GroupLayout.PREFERRED_SIZE, 123, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        ...
                                        .addComponent(other, javax.swing.GroupLayout.DEFAULT_SIZE, 124, Short.MAX_VALUE))
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(acceptorid, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(18, 18, 18)
                        .addComponent(jLabel12)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        showGivenDetail();        // TODO add your handling code here:
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if(itemname.getText().isEmpty())
            ...
            updateGivenRecord();        // TODO add your handling code here:
}//GEN-LAST:event_jButton2ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        showAddedGiven();        // TODO add your handling code here:
}//GEN-LAST:event_jButton3ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        deleteGiven();        // TODO add your handling code here:
    ...
    private javax.swing.JTextField acceptorid;
